...
class WordSearch:
    ...
    def __init__(self, grid: Grid[str] | Sequence[str], case_sensitive: bool = True) -> None:
...
def merge(iterable1: Iterable[T], iterable2: Iterable[T]) -> list[T]:
    """Alternates elements from two iterables into a single list.

    Appending remaining elements from the longer iterable.
    """
