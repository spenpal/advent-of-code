def parse(data: str) -> dict[int, tuple]:
    ...
    input_image = data[1].splitlines()
    print(algorithm)

    return {1: (algorithm, input_image), 2: (algorithm, input_image)}
...
def part1(input_image, algorithm):
    return enhance(input_image, algorithm, 2)


def part2(input_image, algorithm):
    return enhance(input_image, algorithm, 50)
